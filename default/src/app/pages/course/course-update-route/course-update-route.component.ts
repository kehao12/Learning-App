...
@Component({
  selector: 'app-course-update-route',
  templateUrl: './course-update-route.component.html',
  styleUrls: ['./course-update-route.component.scss']
})
export class CourseUpdateRouteComponent implements OnInit {
