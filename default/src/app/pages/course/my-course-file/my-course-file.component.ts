...
@Component({
  selector: 'app-my-course-file',
  templateUrl: './my-course-file.component.html',
  styleUrls: ['./my-course-file.component.scss']
})
export class MyCourseFileComponent implements OnInit {
  lessons: any;
  id: any;
  update: FormGroup;
  mode = 0;
  ...
  changeStatus() {
   ...
   const course = {
    ...
    this.courseService.UpdateStatus(this.id, course).subscribe(next => {
      ...
      this.router.navigate(['/course/my-course']);
    }, error => {
